...
These omissions remain inputs to ongoing validation work. Current publication status is
authenticated by the signed
[commercial-status record](../current-release/COMMERCIAL-STATUS.canonical.json).
